...
const HomePage = (props: Props) => {
  /* webcam and canvas */ 
  /*canvas will be on top of webcam*/
  ...
  return (
    <div className='flex h-screen'>
      ...
      <div className='flex flex-row flex-1'>
          <div className='border-primary/5 border-2 max-w-xs flex flex-col p-4 justify-between gap-2 sahdow-md rounded-md'>
              {/* top section */}
          ...
          <div className='h-full flex-1 py-2 px-2 overflow-y-scroll'>
              <FeaturesHighlights/>
          </div>
      </div>
      {loading && <div className='z-50 absolute w-full h-full flex items-center justify-center bg-primary text-black'>
        Gettings things ready...<Rings height={50} color='red'/> </div>}
    </div>
  )
  ...
  function userPromptScreenshot(){
      ...
      if(!webcamRef.current){
        ...
        const imgSrc = webcamRef.current.getScreenshot(); // this comes as a Base64 format that means you have to convert it somehow 
  ...
  function userPromptRecord(){
      ...
      if(mediaRecorderRef.current?.state=='recording'){
        ...
        toast('Recording saved in downloads');
      }
      else{
